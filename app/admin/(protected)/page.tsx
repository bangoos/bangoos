  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold text-white mb-2 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Dashboard Admin</h1>
          <p className="text-slate-400 text-lg">Kelola konten website BangOos Web dengan mudah</p>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div className={`w-16 h-16 rounded-2xl ${stat.bg} ${stat.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  <stat.icon size={32} />
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 backdrop-blur-xl border border-slate-700/50 p-6 rounded-2xl shadow-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <a
              href="/admin/blog"
              className="group relative overflow-hidden bg-gradient-to-r from-blue-600/20 to-blue-500/20 border border-blue-500/30 text-blue-400 px-4 py-3 rounded-xl font-medium hover:from-blue-600/30 hover:to-blue-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lg"
            >
            ...
            <a
              ...
              className="group relative overflow-hidden bg-gradient-to-r from-cyan-600/20 to-cyan-500/20 border border-cyan-500/30 text-cyan-400 px-4 py-3 rounded-xl font-medium hover:from-cyan-600/30 hover:to-cyan-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lg"
            >
              <span className="relative z-10 flex items-center justify-center gap-2">
            ...
            <a
              href="/admin/products"
              className="group relative overflow-hidden bg-gradient-to-r from-purple-600/20 to-purple-500/20 border border-purple-500/30 text-purple-400 px-4 py-3 rounded-xl font-medium hover:from-purple-600/30 hover:to-purple-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lg"
            >
              <span className="relative z-10 flex items-center justify-center gap-2">
        ...
        <div className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 backdrop-blur-xl border border-slate-700/50 p-6 rounded-2xl shadow-2xl">
          ...
          <div className="space-y-4">
            {recentActivity.map((activity, index) => (
              <div key={index} className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-700/30 transition-colors duration-200">
                <div className={`w-10 h-10 rounded-xl ${activity.color.replace("text", "bg").replace("400", "500/20")} ${activity.color} flex items-center justify-center`}>
      ...
      <div className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 backdrop-blur-xl border border-slate-700/50 p-6 rounded-2xl shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto bg-green-500/20 border border-green-500/30 rounded-full flex items-center justify-center mb-3">
          ...
          <div className="text-center">
            <div className="w-16 h-16 mx-auto bg-blue-500/20 border border-blue-500/30 rounded-full flex items-center justify-center mb-3">
          ...
          <div className="text-center">
            <div className="w-16 h-16 mx-auto bg-purple-500/20 border border-purple-500/30 rounded-full flex items-center justify-center mb-3">
          ...
          <div className="text-center">
            <div className="w-16 h-16 mx-auto bg-cyan-500/20 border border-cyan-500/30 rounded-full flex items-center justify-center mb-3">
